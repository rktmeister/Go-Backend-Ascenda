...
module.exports.inputFilterBar = async (
    ...
    await driver.wait(until.elementLocated(By.id("numberOfRooms"), 10000)).sendKeys(Key.BACK_SPACE + numberOfRooms);

    await driver.findElement(By.id("checkInDate")).sendKeys(checkInDate);
    await driver.findElement(By.id("checkOutDate")).sendKeys(checkOutDate);

    await driver.findElement(By.xpath("//div[@id='priceSlider']//input[contains(@class, 'input-type-range-min')]")).sendKeys(Key.RIGHT.repeat(Math.floor(minPrice / 100)));
    await driver.findElement(By.xpath("//div[@id='priceSlider']//input[contains(@class, 'input-type-range-max')]")).sendKeys(Key.LEFT.repeat(Math.floor((10000 - maxPrice) / 100)));

    await driver.findElement(By.xpath("//div[@id='ratingSlider']//input[contains(@class, 'input-type-range-min')]")).sendKeys(Key.RIGHT.repeat(minRating));
    await driver.findElement(By.xpath("//div[@id='ratingSlider']//input[contains(@class, 'input-type-range-max')]")).sendKeys(Key.LEFT.repeat(5 - maxRating));
