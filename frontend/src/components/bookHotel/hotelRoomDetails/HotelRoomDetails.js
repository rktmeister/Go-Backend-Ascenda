    ...
    return (
      <div className="HotelRoomDetails">
        ...
        <h1 className="Hotelname">
          {props.handMeDowns.hotel.name}
        </h1>



        <MapGenerator latitude={props.handMeDowns.hotel.latitude} longitude={props.handMeDowns.hotel.longitude} />
        ...
        {/* Filter Reference: https://www.youtube.com/watch?v=MY6ZZIn93V8   5: 57 */}
        {
          rooms.filter((room) => (((room.price > minPrice && room.price < maxPrice) || filterSettingForPrice === "-1") &&
            ...
            console.log("Room ", room), <HotelRoomBox key={room.key} description={room.description} price={room.price} />
          ))
        }
